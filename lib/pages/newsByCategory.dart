...
class NewsByCategory extends StatefulWidget {
  ...
  NewsByCategory({this.cat_id, this.categoryName});
...
class _NewsByCategoryState extends State<NewsByCategory> {
  ...
  List<NewsModel> _modelNewsByCategory = <NewsModel>[];

  Future<List<NewsModel>> getLastNews() async {
    String link =
        "http://sudanews.sudagoras.com//api.php?cat_id=${widget.cat_id}";
    var res = await http
...
//        ),
  ...
  Widget _buildLastNews() {
    return ListView.builder(
      itemCount: _modelNewsByCategory.length,
      itemBuilder: (BuildContext context, int index) {
        final _lastNewsObj = _modelNewsByCategory[index];
