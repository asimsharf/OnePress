...
class _ShareContentState extends State<ShareContent> {
  ...
  Future<void> _shareImage() async {
    try {
      ...
      await Share.file(
          'esys image', 'logo.png', bytes.buffer.asUint8List(), 'image/png',
  ...
  Future<void> _shareImages() async {
    try {
      final ByteData bytes1 = await rootBundle.load('assets/logo.png');
      final ByteData bytes2 = await rootBundle.load('assets/logo.png');
